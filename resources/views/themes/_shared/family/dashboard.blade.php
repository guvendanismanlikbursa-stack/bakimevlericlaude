...
<div class="max-w-6xl mx-auto px-4 py-10">
  ...
  <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
    ...
    {{-- 26 Agustos 2026: kullanicinin talebi - "Yakınımı Ziyaret Et"
         (ucretli, kurumda kalan yakina periyodik ziyaret+rapor) talebi.
         Isim bilerek "takip/denetleme" cagristirmayacak, aile odakli
         secildi (kullanicinin acik talebi). --}}
    <a href="{{ brand_route('family.visit-service.index') }}" class="bg-white rounded-lg shadow-sm border border-gray-100 p-5 hover:shadow-md">
      <div class="text-xs font-semibold text-primary">Ziyaret Hizmeti</div>
      <div class="font-black text-gray-950 mt-1">Yakınımı Ziyaret Et</div>
