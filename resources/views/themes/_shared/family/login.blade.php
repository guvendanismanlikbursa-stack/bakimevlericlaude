...
<div class="max-w-md mx-auto px-4 py-12">
  ...
  {{-- 1 Eylul 2026: kullanicinin talebi - kalp (favori) ikonuna giris
       yapmadan basan bir kullanici, hicbir aciklama olmadan sessizce bu
       sayfaya dusuyordu (bkz. engagement-script.blade.php). ?favori=1
       sorgu parametresiyle gelince kisa bir bilgilendirme gosterilir. --}}
  @if(request()->boolean('favori'))
    <div class="rounded-lg bg-blue-50 border border-blue-200 text-blue-800 text-sm px-4 py-3 mb-4">
      Bir kurumu favorilere eklemek için önce giriş yapmalısınız. Hesabınız yoksa Google ile veya birkaç saniyede ücretsiz oluşturabilirsiniz.
    </div>
  @endif
