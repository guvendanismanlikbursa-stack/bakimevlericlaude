...
<div class="max-w-2xl mx-auto px-4 py-10">
  ...
  <div id="js-thread-messages" data-last-id="{{ $offerRequest->messages->max('id') ?? 0 }}" data-own-sender="family" class="bg-white rounded-xl shadow-sm p-4 space-y-3 mb-4 max-h-96 overflow-y-auto">
...
@include('themes._shared.partials.thread-polling-script', ['pollUrl' => brand_route('family.thread.poll', $offerRequest)])
@endsection
