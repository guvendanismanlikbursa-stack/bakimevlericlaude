...
<div class="max-w-6xl mx-auto px-4 -mt-1 mb-2">
  <div class="grid grid-cols-3 gap-3 md:gap-6 py-5 border-t border-b border-gray-100">
    <div class="text-center">
      <div class="text-xl md:text-2xl font-black text-gray-950">{{ number_format($facilityCount) }}</div>
    ...
    <div class="text-center">
      <div class="text-xl md:text-2xl font-black text-gray-950">{{ number_format($claimedCount) }}</div>
