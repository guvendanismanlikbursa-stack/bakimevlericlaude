...
// Il merkezlerinin yaklasik enlem/boylam degerleri. "Yakinimdaki Kurumlar"
// ozelligi, kurum bazinda konum verisi olmadigi icin (veri cekici GPS
// koordinati toplamiyor), tarayici konumunu en yakin il merkezine
// eslestirip o ile yonlendirir. Kurum bazinda gercek GPS mesafesi icin
// ileride facilities tablosuna lat/lng eklenip veri cekiciyle
// doldurulmasi gerekir.
return [
    ...
    'Balıkesir' => [39.6484, 27.8826], 'Bilecik' => [40.1451, 29.9793], 'Bingöl' => [38.8855, 40.4966],
    'Bitlis' => [38.4006, 42.1095], 'Bolu' => [40.7392, 31.6089], 'Burdur' => [37.7203, 30.2908],
    'Bursa' => [40.1826, 29.0669], 'Çanakkale' => [40.1553, 26.4142], 'Çankırı' => [40.6013, 33.6134],
